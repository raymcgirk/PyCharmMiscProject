...
# Replace this with your desired folder (e.g., the one with the trust letters)
PDF_FOLDER = r"C:\Your_folder"
WAIT_BETWEEN_PRINTS = 15  # seconds
WAIT_IF_NOT_READY = 30    # seconds
# =============================

# Define printer status flags
...
pdf_files.sort(key=lambda x: os.path.getmtime(x))  # Sort oldest to newest
